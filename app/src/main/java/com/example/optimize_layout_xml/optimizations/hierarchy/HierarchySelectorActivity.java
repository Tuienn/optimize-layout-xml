...
public class HierarchySelectorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hierarchy_selector);
        ...
        btnUnoptimized.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HierarchySelectorActivity.this, UnoptimizedActivity.class);
        ...
        btnOptimized.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HierarchySelectorActivity.this, OptimizedActivity.class);
                startActivity(intent);
            }
        });
    }
